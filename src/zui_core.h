...
#define ZUI_DYNARRAY_GET_TYPE(array, type, index) \
    ...
    static ZuiOptionInt ZuiSomeInt(int v);
    static bool ZuiHasInt(ZuiOptionInt o);
    static ZuiOptionColor ZuiSomeColor(Color v);
    static bool ZuiHasColor(ZuiOptionColor o);
    static ZuiOptionString ZuiSomeString(const char *v);
    static bool ZuiHasString(ZuiOptionString o);
    static ZuiOptionVector2 ZuiSomeVector2(Vector2 v);
    static bool ZuiHasVector2(ZuiOptionVector2 o);
    static ZuiOptionNPatchInfo ZuiSomeNPatchInfo(NPatchInfo v);
    static bool ZuiHasNPatchInfo(ZuiOptionNPatchInfo o);
    static ZuiOptionTexture2D ZuiSomeTexture2D(Texture2D v);
    static bool ZuiHasTexture2D(ZuiOptionTexture2D o);
    static ZuiOptionRectangle ZuiSomeRectangle(Rectangle v);
    static bool ZuiHasRectangle(ZuiOptionRectangle o);
    static ZuiOptionFloat ZuiSomeFloat(float v);
    static bool ZuiHasFloat(ZuiOptionFloat o);
    static ZuiOptionFont ZuiSomeFont(Font v);
    static bool ZuiHasFont(ZuiOptionFont o);
...
#define zui_has(...) _Generic(__VA_ARGS__, \
    ...
    static bool ZuiIsPowerOfTwo(size_t n);
    static const char *ZuiGetWidgetType(ZuiItemType type);
    static const char *ZuiResultToString(ZuiResult result);

    /// Function Declarations - Arena

    static ZuiResult ZuiInitArena(ZuiArena *arena, size_t capacity);
    static void ZuiUnloadArena(ZuiArena *arena);
    void ZuiResetArena(ZuiArena *arena);
    static void *ZuiAllocArena(ZuiArena *arena, size_t size, size_t alignment);
    static void *ZuiAllocArenaDefault(ZuiArena *arena, size_t size);
    static ZuiArenaStats ZuiGetArenaStats(const ZuiArena *arena);
    static void ZuiPrintArenaStats(const ZuiArena *arena);
    static bool ZuiIsArenaValid(const ZuiArena *arena);

    /// Function Declarations - Dynamic Array

    static ZuiResult ZuiInitDynArray(ZuiDynArray *array, ZuiArena *arena, unsigned int initialCapacity,
                                     size_t itemSize, size_t itemAlignment, const char *typeName);
    static ZuiResult ZuiGrowDynArray(ZuiDynArray *array, ZuiArena *arena);
    static void *ZuiPushDynArray(ZuiDynArray *array, ZuiArena *arena);
    static void *ZuiGetDynArray(const ZuiDynArray *array, unsigned int index);
    static void ZuiClearDynArray(ZuiDynArray *array);
    static bool ZuiIsDynArrayValid(const ZuiDynArray *array);
    static ZuiDynArrayStats ZuiGetDynArrayStats(const ZuiDynArray *array);
    void ZuiPrintDynArrayStats(const ZuiDynArray *array);

    /// Function Declarations - Label

    static Vector2 ZuiGetLabelSize(ZuiLabel const *label);
    void ZuiClearLabel(ZuiDynArray *array);
    unsigned int ZuiCountLabel(ZuiDynArray const *array);
    static void ZuiRenderLabel(void *item);
    static void ZuiConfigureLabel(ZuiLabel *label, const ZuiLabelPreset *preset);
    static ZuiLabelPreset ZuiGetDefaultLabelPreset(void);
    static ZuiLabelId ZuiCreateLabel(const char *text, ZuiDynArray *array, Font font, ZuiArena *arena);
    static bool ZuiValidateBounds(Rectangle bounds);
    static bool ZuiValidateLabelId(const ZuiDynArray *array, ZuiLabelId id);
    static bool ZuiValidateSetLabelText(ZuiLabelId id, const char *text, const ZuiDynArray *array);
    static bool ZuiValidateSetLabelFont(ZuiLabelId id, Font font, const ZuiDynArray *array);
    static bool ZuiValidateSetLabelBounds(ZuiLabelId id, Rectangle bounds, const ZuiDynArray *array);
    ...
    static void ZuiSetLabelTextColor(ZuiLabelId id, Color textColor);
    static void ZuiSetLabelBackgroundColor(ZuiLabelId id, Color backgroundColor);
    static void ZuiSetLabelBounds(ZuiLabelId id, Rectangle bounds);
    void ZuiSetLabelSpacing(ZuiLabelId id, unsigned int spacing);
    void ZuiSetLabelFontSize(ZuiLabelId id, unsigned int fontSize);
    static void ZuiSetLabelHasBackground(ZuiLabelId id, bool hasBackground);
    ...
    static Rectangle ZuiGetLabelBounds(ZuiLabelId id);
    ...
    static ZuiResult ZuiInitFrame(ZuiDynArray *array, ZuiArena *arena, unsigned int initialCapacity);
    static ZuiFrame *ZuiPushFrame(ZuiDynArray *array, ZuiArena *arena);
    static ZuiFrame *ZuiGetFrame(const ZuiDynArray *array, unsigned int index);
    void ZuiClearFrame(ZuiDynArray *array);
    static unsigned int ZuiGetFrameCount(ZuiDynArray const *array);
    static ZuiResult ZuiInitFrameItems(ZuiFrame *frame, ZuiArena *arena, size_t initialCapacity);
    static ZuiResult ZuiGrowFrameItems(ZuiFrame *frame, ZuiArena *arena);
    static ZuiResult ZuiAddFrameItem(ZuiFrame *frame, void *data, ZuiRenderFunction render_func,
                                     ZuiUpdateFunction update_func, ZuiItemOptions options, ZuiArena *arena);
    static void ZuiUpdateFrame(void *itemFrame);
    static float ZuiPixelsToRoundness(Rectangle rect, float radius_px);
    static void ZuiRenderFrame(void *itemFrame);
    void ZuiRenderFrameItem(void *item);
    static bool ZuiIsChildAncestor(const ZuiFrame *potentialParent, const ZuiFrame *frame);
    void ZuiUpdateFrameItem(void *item);
    static Rectangle ZuiGetContentArea(Rectangle parent, ZuiPadding padding);
    static Rectangle ZuiAlignRectangle(Rectangle parent, Vector2 childSize, ZuiPadding padding, ZuiAlignment alignment);
    static Rectangle ZuiGetBoundsFromVectors(Vector2 position, Vector2 size);
    static Vector2 ZuiGetPositionFromBounds(Rectangle bounds);
    static Vector2 ZuiGetSizeFromBounds(Rectangle bounds);
    ...
    static ZuiFrameId ZuiCreateFrame(Rectangle bounds, Color color, ZuiDynArray *frameArray, ZuiArena *arena);
    static bool ZuiValidateFrameId(const ZuiDynArray *array, ZuiFrameId id);
    static bool ZuiValidateFrameBounds(Rectangle bounds);
    static bool ZuiValidateSetFrameBounds(ZuiFrameId id, Rectangle bounds, const ZuiDynArray *array);
    static bool ZuiValidateFramePadding(float padding);
    static bool ZuiValidateFrameSpacing(float spacing);
    static bool ZuiValidateFrameOutlineThickness(float thickness);
    void ZuiInternalPrintFrame(const ZuiFrame *frame);
    static ZuiResult ZuiAddChildFrame(ZuiFrameId parentId, ZuiFrameId childId, ZuiItemOptions options);
    static ZuiResult ZuiAddLabel(ZuiFrameId parentId, ZuiLabelId childId, ZuiItemOptions options, ZuiArena *arena);
    void ZuiAlignHorizontalItem(ZuiFrame *frame, int startIndex, int endIndex, ZuiAlignmentY alignment);
    static void ZuiSetFrameBounds(ZuiFrameId id, Rectangle bounds);
    static void ZuiSetFrameBackgroundColor(ZuiFrameId id, Color color);
    static void ZuiSetFrameOutlineColor(ZuiFrameId id, Color color);
    static void ZuiSetFramePadding(ZuiFrameId id, float padding);
    static void ZuiSetFrameGap(ZuiFrameId id, float gap);
    static void ZuiSetFrameOutlineThickness(ZuiFrameId id, float thickness);
    static void ZuiSetFrameHasBackground(ZuiFrameId id, bool hasBackground);
    static void ZuiSetFrameHasOutline(ZuiFrameId id, bool hasOutline);
    void ZuiSetFrameIsVisible(ZuiFrameId id, bool isVisible);
    void ZuiSetFrameParentId(ZuiFrameId id, ZuiFrameId parentId);
    static Rectangle ZuiGetFrameBounds(ZuiFrameId id);
    Color ZuiGetFrameBackgroundColor(ZuiFrameId id);
    Color ZuiGetFrameOutlineColor(ZuiFrameId id);
    static float ZuiGetFramePadding(ZuiFrameId id);
    ...
    static void ZuiAdvanceCursor(float width, float height);
    void ZuiPrintCursor(void);
    static void ZuiAdvanceLine(void);
    ...
    static bool ZuiIsInitialized(void);
    ...
    static ZuiLabelId ZuiLabelEx(const char *text, bool isMono);
...
static bool ZuiIsPowerOfTwo(size_t const n)
{
    return n > 0 && (n & (n - 1)) == 0;
}

static const char *ZuiGetWidgetType(const ZuiItemType type)
{
    switch (type)
    {
    case ZUI_FRAME:
...
static const char *ZuiResultToString(const ZuiResult result)
{
    switch (result)
    {
    case ZUI_OK:
...
static ZuiResult ZuiInitArena(ZuiArena *arena, const size_t capacity)
{
    // Preconditions
    if (!arena)
    {
...
static void *ZuiAllocArena(ZuiArena *arena, size_t size, const size_t alignment)
{
    // Validate parameters
    if (!arena)
    {
    ...
    // Explicit check for arena buffer (helps static analyzers understand the invariant)
    if (arena->buffer == NULL)
    {
    ...
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_OVERFLOW, "Allocation size overflow");
        return NULL;
    }

    /* Calculate aligned offset relative to buffer start */
    uintptr_t current_ptr = (uintptr_t)(arena->buffer + arena->offset);
    uintptr_t mask = alignment - 1;
    if (current_ptr > UINTPTR_MAX - mask)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_OVERFLOW, "Alignment calculation would overflow");
        return NULL;
    }
    ...
    /* Check capacity */
    if (aligned_offset > SIZE_MAX - size || aligned_offset + size > arena->capacity)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_ARENA_EXHAUSTED,
                         "Arena out of memory: requested %zu bytes, available %zu bytes",
                         size, arena->capacity - arena->offset);
        return NULL;
    }

    // At this point, ptr is guaranteed non-NULL because:
    // 1. arena->buffer is validated non-NULL above
    // 2. aligned_ptr is derived from arena->buffer + offset
    // 3. All arithmetic has been validated for overflow
    void *ptr = (void *)aligned_ptr;

    // Post-condition: Verify alignment calculation is correct
...
static void *ZuiAllocArenaDefault(ZuiArena *arena, const size_t size)
{
    if (!arena)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER, "Arena pointer is NULL");
...
static ZuiResult ZuiInitDynArray(ZuiDynArray *array, ZuiArena *arena, const unsigned int initialCapacity,
...
static void *ZuiPushDynArray(ZuiDynArray *array, ZuiArena *arena)
{
    ...
    unsigned char *items = array->items;
    void *slot = items + array->itemSize * array->count;
    array->count++;

    return slot;
}

static void *ZuiGetDynArray(const ZuiDynArray *array, const unsigned int index)
{
    if (!array)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER,
    ...
    unsigned char *items = array->items;
    return items + array->itemSize * index;
}
...
static ZuiOptionInt ZuiSomeInt(const int v)
{
    return (ZuiOptionInt){.has = true, .value = v};
}

static bool ZuiHasInt(ZuiOptionInt const o)
{
    return o.has;
}

static ZuiOptionColor ZuiSomeColor(const Color v)
{
    return (ZuiOptionColor){.has = true, .value = v};
}

static bool ZuiHasColor(ZuiOptionColor const o)
{
    return o.has;
}
...
static bool ZuiHasString(ZuiOptionString const o)
{
    return o.has;
}

static ZuiOptionVector2 ZuiSomeVector2(const Vector2 v)
{
    return (ZuiOptionVector2){.has = true, .value = v};
}

static bool ZuiHasVector2(ZuiOptionVector2 const o)
{
    return o.has;
}

static ZuiOptionNPatchInfo ZuiSomeNPatchInfo(const NPatchInfo v)
{
    return (ZuiOptionNPatchInfo){.has = true, .value = v};
}

static bool ZuiHasNPatchInfo(ZuiOptionNPatchInfo const o)
{
    return o.has;
}

static ZuiOptionTexture2D ZuiSomeTexture2D(const Texture2D v)
{
    return (ZuiOptionTexture2D){.has = true, .value = v};
}

static bool ZuiHasTexture2D(ZuiOptionTexture2D const o)
{
    return o.has;
}

static ZuiOptionRectangle ZuiSomeRectangle(const Rectangle v)
{
    return (ZuiOptionRectangle){.has = true, .value = v};
}

static bool ZuiHasRectangle(ZuiOptionRectangle const o)
{
    return o.has;
}

static ZuiOptionFloat ZuiSomeFloat(const float v)
{
    return (ZuiOptionFloat){.has = true, .value = v};
}

static bool ZuiHasFloat(ZuiOptionFloat const o)
{
    return o.has;
}

static ZuiOptionFont ZuiSomeFont(const Font v)
{
    return (ZuiOptionFont){.has = true, .value = v};
}

static bool ZuiHasFont(ZuiOptionFont const o)
{
    return o.has;
}
...
static ZuiResult ZuiInitLabel(ZuiDynArray *array, ZuiArena *arena, const unsigned int initialCapacity)
{
    if (!array)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER,
...
static ZuiLabel *ZuiPushLabel(ZuiDynArray *array, ZuiArena *arena)
{
    if (!array)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER,
...
static ZuiLabel *ZuiGetLabel(const ZuiDynArray *array, const unsigned int index)
{
    if (!array)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER, "Dynamic array pointer is NULL");
...
static void ZuiInternalPrintLabel(const ZuiLabel *label)
{
    if (!label)
    {
...
static ZuiResult ZuiInitFrame(ZuiDynArray *array, ZuiArena *arena, const unsigned int initialCapacity)
{
    // Preconditions
    if (!array)
    {
...
static ZuiFrame *ZuiGetFrame(const ZuiDynArray *array, const unsigned int index)
{
    if (!array)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER, "Dynamic array pointer is NULL");
...
static ZuiResult ZuiInitFrameItems(ZuiFrame *frame, ZuiArena *arena, const size_t initialCapacity)
{
    if (!frame || !arena)
    {
...
static ZuiResult ZuiAddFrameItem(ZuiFrame *frame, void *data, const ZuiRenderFunction render_func,
                                 const ZuiUpdateFunction update_func, const ZuiItemOptions options, ZuiArena *arena)
{
    ...
    if (!render_func)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER, "Render function is NULL");
        return ZUI_ERROR_NULL_POINTER;
    }
...
static float ZuiPixelsToRoundness(const Rectangle rect, float radius_px)
{
    ...
    if (radius_px < 0.0f)
        radius_px = 0.0f;
    if (radius_px > min_dimension * 0.5f)
        radius_px = min_dimension * 0.5f;

    return radius_px / min_dimension;
}
...
void ZuiRenderFrameItem(void *item)
{
    ...
    ZUI_ASSERT(renderItem != NULL, "ZUI Error: item pointer is NULL");

    renderItem->function(renderItem->data);
}

static bool ZuiIsChildAncestorRecursive(const ZuiFrame *potentialParent,
                                        const ZuiFrame *frame,
                                        const int depth)
{
    if (depth > ZUI_MAX_ANCESTOR_DEPTH)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_CIRCULAR_REFERENCE,
                         "Ancestor search exceeded max depth %d (possible cycle)",
                         ZUI_MAX_ANCESTOR_DEPTH);
        return false;
    }

    // Base case: no more children to check
    if (!frame || !frame->items || frame->itemCounter <= 0)
    {
        return false;
    }
    ...
    for (int i = 0; i < frame->itemCounter; i++)
    {
        ZuiItem const *item = &frame->items[i];

        // Only check frame items (not labels, buttons, etc.)
        if (item->renderFunction == ZuiRenderFrameItem)
        {
            ZuiFrame const *childFrame = item->data;

            if (!childFrame)
            {
                ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER,
                                 "NULL child frame in ancestor search at depth %d", depth);
                continue;
            }

            // Direct match
            if (childFrame == potentialParent)
                return true;

            // Recursive search with incremented depth
            if (ZuiIsChildAncestorRecursive(potentialParent, childFrame, depth + 1))
                return true;
        }
    }
...
static bool ZuiIsChildAncestor(const ZuiFrame *potentialParent, const ZuiFrame *frame)
{
    ...
    if (frame == potentialParent)
        return true;
    return ZuiIsChildAncestorRecursive(potentialParent, frame, 0);
}
...
void ZuiUpdateFrameItem(void *item)
{
    ...
    ZuiFrame *frame = item;
    ZUI_ASSERT(frame != NULL, "ZUI Error: item pointer is NULL");
    ZuiUpdateFrame(frame);
}

static Rectangle ZuiGetContentArea(const Rectangle parent, const ZuiPadding padding)
{
    return (Rectangle){
...
static Rectangle ZuiAlignRectangle(const Rectangle parent, const Vector2 childSize,
...
static Rectangle ZuiGetBoundsFromVectors(const Vector2 position, const Vector2 size)
{
    return (Rectangle){position.x, position.y, size.x, size.y};
}

static Vector2 ZuiGetPositionFromBounds(const Rectangle bounds)
{
    return (Vector2){bounds.x, bounds.y};
}

static Vector2 ZuiGetSizeFromBounds(const Rectangle bounds)
{
...
static ZuiFrameId ZuiCreateFrame(const Rectangle bounds, const Color color, ZuiDynArray *frameArray, ZuiArena *arena)
{
    if (!frameArray || !arena)
    {
    ...
    *frame = (ZuiFrame){0};
    ...
    frame->id = (ZuiFrameId){frameArray->count - 1};
    frame->data.backgroundColor = color;
    frame->data.padding = ZUI_DEFAULT_FRAME_PADDING;
    frame->data.gap = ZUI_DEFAULT_FRAME_GAP;
...
static bool ZuiValidateFrameId(const ZuiDynArray *array, const ZuiFrameId id)
{
    if (!array)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_POINTER, "Null array pointer passed to ZuiValidateFrameId");
        return false;
    }
...
static bool ZuiValidateFrameBounds(const Rectangle bounds)
{
    if (bounds.width < 0 || bounds.height < 0)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_INVALID_VALUE, "Bounds have negative dimensions");
...
static bool ZuiValidateSetFrameBounds(const ZuiFrameId id, const Rectangle bounds, const ZuiDynArray *array)
{
...
static bool ZuiValidateFramePadding(const float padding)
{
    if (padding < 0.0f)
    {
...
static bool ZuiValidateFrameSpacing(const float spacing)
{
    if (spacing < 0.0f)
    {
...
static bool ZuiValidateFrameOutlineThickness(const float thickness)
{
    // Runtime validation
    if (thickness < 0.0f)
    {
...
/**
 * @brief Add a child frame to a parent frame with comprehensive validation
 * @param parentId ID of the parent frame
 * @param childId ID of the child frame to add
 * @param options Item configuration options
 * @return ZUI_OK on success, error code otherwise
 */
static ZuiResult ZuiAddChildFrame(const ZuiFrameId parentId, const ZuiFrameId childId, ZuiItemOptions options)
{
...
static ZuiResult ZuiAddLabel(const ZuiFrameId parentId, const ZuiLabelId childId, ZuiItemOptions options, ZuiArena *arena)
{
    // Validate global context
    if (!g_zui_ctx)
    {
...
static Rectangle *ZuiGetItemBoundsFromFrames(const ZuiItem *item)
{
    // Runtime check
    if (!item)
    {
...
void ZuiAlignHorizontalItem(ZuiFrame *frame, const int startIndex, const int endIndex, const ZuiAlignmentY alignment)
{
    ...
    if (first_bounds->height <= 0.0f)
    {
        TraceLog(LOG_WARNING, "ZUI: First item has invalid height for alignment");
        return;
    }
    ...
    for (int i = 1; i < count; i++)
    {
        ...
        if (item_bounds != NULL && item_bounds->height > 0.0f)
        {
            switch (alignment)
            {
            case ZUI_ALIGN_Y_TOP:
...
static void ZuiSetFrameBounds(const ZuiFrameId id, const Rectangle bounds)
{
    if (ZuiValidateSetFrameBounds(id, bounds, &g_zui_ctx->frameArray))
        ZuiGetFrame(&g_zui_ctx->frameArray, id.value)->data.bounds = bounds;
}

static void ZuiSetFrameBackgroundColor(const ZuiFrameId id, const Color color)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id))
        ZuiGetFrame(&g_zui_ctx->frameArray, id.value)->data.backgroundColor = color;
}

static void ZuiSetFrameOutlineColor(const ZuiFrameId id, const Color color)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id))
        ZuiGetFrame(&g_zui_ctx->frameArray, id.value)->data.outlineColor = color;
}

static void ZuiSetFramePadding(const ZuiFrameId id, const float padding)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id) && ZuiValidateFramePadding(padding))
        ZuiGetFrame(&g_zui_ctx->frameArray, id.value)->data.padding = padding;
}

static void ZuiSetFrameGap(const ZuiFrameId id, const float gap)
{
...
static void ZuiSetFrameOutlineThickness(const ZuiFrameId id, const float thickness)
{
...
static void ZuiSetFrameHasBackground(const ZuiFrameId id, const bool hasBackground)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id))
        ZuiGetFrame(&g_zui_ctx->frameArray, id.value)->data.hasBackground = hasBackground;
}

static void ZuiSetFrameHasOutline(const ZuiFrameId id, const bool hasOutline)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id))
...
//------------------------------------------------------------------Frame get
static Rectangle ZuiGetFrameBounds(const ZuiFrameId id)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id))
...
static float ZuiGetFramePadding(const ZuiFrameId id)
{
    if (ZuiValidateFrameId(&g_zui_ctx->frameArray, id))
        return ZuiGetFrame(&g_zui_ctx->frameArray, id.value)->data.padding;
...
static void ZuiAdvanceCursor(const float width, const float height)
{
    // Validate global context
    if (!g_zui_ctx)
    {
...
static ZuiLabelId ZuiLabelEx(const char *text, const bool isMono)
{
    if (!g_zui_ctx)
    {
        ZUI_REPORT_ERROR(ZUI_ERROR_NULL_CONTEXT, "Global context is NULL");
...
void ZuiFramePad(const float pad)
{
    ...
    Rectangle bounds = ZuiGetFrameBounds(id);
    g_zui_ctx->cursor.position = (Vector2){bounds.x + pad, bounds.y + pad};
    g_zui_ctx->cursor.restPosition = g_zui_ctx->cursor.position;
    g_zui_ctx->cursor.tempRestPosition = g_zui_ctx->cursor.position;
}
...
void ZuiLabelAlignX(const ZuiAlignmentX align)
{
    ...
    case ZUI_ALIGN_X_CENTER:
        label_bounds.x = frame_bounds.x + frame_bounds.width / 2 - label_bounds.width / 2;
        break;
...
void ZuiUpdate(void)
{
    ...
    unsigned int frame_count = ZuiGetFrameCount(&g_zui_ctx->frameArray);

    // Iterate backwards for rendering order
    for (int i = (int)frame_count - 1; i >= 0; i--)
    {
        ZuiFrame *frame = ZuiGetFrame(&g_zui_ctx->frameArray, (unsigned int)i);

        if (frame == NULL)
        {
            // TraceLog(LOG_WARNING, "ZUI: Null frame at index %d during update", i);
            continue;
        }

        if (frame->isVisible)
        {
            // TraceLog(LOG_INFO, "frame update %d, frame pointer: :%p", i, frame);
            ZuiUpdateFrame(frame);
        }
        // TraceLog(LOG_INFO, "frame update %d", i);
    }
}
...
void ZuiRender(void)
{
    ...
    // Frame_count might change when dynarray grows
    unsigned int frame_count = ZuiGetFrameCount(&g_zui_ctx->frameArray);
    ...
    for (int i = (int)frame_count - 1; i >= 0; i--)
    {
        ...
        if (frame == NULL)
        {
            // TraceLog(LOG_WARNING, "ZUI: Null frame at index %d during render", i);
            continue;
        }

        if (frame->isVisible)
        {
            // TraceLog(LOG_INFO, "frame render %d frame pointer: :%p", i, frame);
            ZuiRenderFrame(frame);
        }
        // TraceLog(LOG_INFO, "frame render %d", i);
    }
}
...
bool ZuiInit(void)
{
    ...
    // Initialize global arena - CRITICAL: Check the result!
